...
//    label.transform = CGAffineTransformMakeScale(trueScale, trueScale);
    ...
    [(id<adjustTitleViewProtocol>)view setBackgroundColor:[UIColor colorWithRed:0.373 + (0.980 - 0.373) * scale green:0.396 - (0.396 - 0.271) * scale blue:0.459 - (0.459 - 0.196) * scale alpha:1]];
