...
//    [self addSubview:titleView];
    ...
    [titleView configWithModels:muArr customViewClass:[LJTestTitleView class] viewSize:CGSizeMake(150, 50)];
    [self addSubview:titleView];
    ...
    LJPageContentView *contentView = [[LJPageContentView alloc] initWithFrame:CGRectMake(0, 200, screenW, screenH - 100)];
